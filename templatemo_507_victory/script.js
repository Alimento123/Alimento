...
$('.add-button').on('click', function () {
  ...
  $('.cart-math').html(`
    <p class="cart-math-item">
      ...
      <span class="g-price subtotal">INR${formattedSubtotal}</span>
    </p>
    <p class="cart-math-item">
      <span class="cart-math-header">Tax:</span>
      <span class="g-price tax">INR${tax}</span>
    </p>
    <p class="cart-math-item">
      <span class="cart-math-header">Total:</span>
      <span class="g-price total">INR${total}</span>
    </p>
  `);
});